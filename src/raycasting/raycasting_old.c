...
/*   Updated: 2025/06/20 17:42:41 by pdrettas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// TODO: fix 4 lines of code below when facing other directions (S W E)
...
// 		// in which direction ray is pointing for this pixel column x on screen 
//         // (column x 0 (far left), 320 straight, 639 right)
...
// 	// When the ray direction is 0 (ray going perfectly horizontal or vertical),
// 		// we set delta distance to a very large number instead of dividing by zero,
...
// 	// ray_angle = atan2(data->ray->ray_dir_y, data->ray->ray_dir_x)
// 		//- atan2(data->vec->dir_y, data->vec->dir_x);
...
// 		// prevent infinite loop (NEW) // data->width
// 	iterations = 0;
// 	ray_hit_wall = false;
...
// 	// calculates how tall wall should appear on screen (closer walls = larger wall height)
